...
from homeward.models.case import MissingPersonCase, Location, CaseStatus, CasePriority
...
class TestMissingPersonForm:
    ...
    def test_form_validation_email_format(self):
        ...
        form_data = {
            ...
            'city': Mock(value='Toronto'),
            'country': Mock(value='Canada'),
            'circumstances': Mock(value='Left for work and never returned home'),  # Valid circumstances
            'reporter_name': Mock(value='Jane Doe'),
            'reporter_phone': Mock(value='416-555-0123'),
...
class TestFormValidationHelpers:
    ...
    def test_validate_name_field_invalid(self):
        ...
        mock_field.props.assert_called_with('error error-message="Only letters, spaces, hyphens, and apostrophes allowed"')
    ...
    def test_validate_email_field_invalid(self):
        ...
        mock_field.props.assert_called_with('error error-message="Please enter a valid email address"')
    ...
    def test_validate_phone_field_invalid(self):
        ...
        mock_field.props.assert_called_with('error error-message="Enter 10-15 digits (spaces, dashes, parentheses allowed)"')
    ...
    def test_validate_age_field_invalid(self):
        ...
        mock_field.props.assert_called_with('error error-message="Age must be between 0 and 150"')