        ...
        with ui.column().classes('w-full'):
            ...
            with ui.row().classes('gap-4'):
                with ui.column().classes('w-48'):
                    ...
                    ui.input('', value='2023-12-01').classes('w-full bg-gray-700/50 text-white border-gray-500 rounded-lg text-sm').props('outlined dense type=date')
                with ui.column().classes('w-48'):
                    ui.label('End Date').classes('text-gray-300 text-xs mb-1')
                    ui.input('', value='2023-12-03').classes('w-full bg-gray-700/50 text-white border-gray-500 rounded-lg text-sm').props('outlined dense type=date')
                with ui.column().classes('w-36'):
                    ui.label('Time Range').classes('text-gray-300 text-xs mb-1')
                    ui.select(['All Day', 'Morning', 'Afternoon', 'Evening', 'Night'], value='All Day').classes('w-full bg-gray-700/50 text-white border-gray-500 rounded-lg text-sm').props('outlined dense')
        ...
        with ui.column().classes('w-full'):
            ...
            with ui.row().classes('gap-4'):
                with ui.column().classes('w-36'):
                    ...
                    ui.number('', value=5, min=1, max=50).classes('w-full bg-gray-700/50 text-white border-gray-500 rounded-lg text-sm').props('outlined dense')
            ...
            with ui.element('div').classes('w-full bg-gray-800/30 rounded-lg border border-gray-700/50 overflow-hidden'):
                ...
                for i, result in enumerate(results):
                    ...
                    with ui.element('div').classes(row_classes):
                        ...
                        ui.label(address_short).classes('text-gray-100 text-sm truncate').props(f'title="{result.address}"')
                        ...
                        ui.label(description_short).classes('text-gray-100 text-sm truncate').props(f'title="{result.ai_description}"')
